...
const HeroLink = () => {
  ...
  return (
    <Link className='w-full' href={currentEventUrl}>
      <div
        className={`mb-10 flex h-32 w-full items-center bg-blackish text-whitish transition duration-300 ease-in-out hover:bg-whitish hover:text-blackish sm:h-36 md:h-40 lg:h-64 `}
      >
