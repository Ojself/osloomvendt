...
const IgQuestionAnswer = ({ q, a, onClick }) => {
  ...
  return (
    ...
    >
      <div
        className={`${animation} ${bounce} ${rotation}   bl m-1 flex w-44 transform flex-col rounded-2xl text-center font-source-sans font-medium  duration-300 md:m-2 md:w-72`}
      >
