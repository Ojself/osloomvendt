...
const VippsIcon = ({ height, width }) => {
  return (
    <svg
      ...
      height={height}
      width={width}
      className='bg-vippsOrange'
      aria-label='Vipps logo'
    >
      <path
        d='M28 22l5.1 14.9 5-14.9H44l-8.8 22.1h-4.4L22 22h6z'
        className='fill-white'
      ></path>
      <path
        d='M141.4 38.1l14.9-5.1-14.9-5v-6l22.1 8.8v4.4L141.4 44v-5.9zM28 44l5.1 14.9 5-14.9H44l-8.8 22.1h-4.4L22 44h6zM38.1 22.1L33 7.2l-5 14.9h-6L30.9 0h4.4l8.8 22.1h-6z'
        className='fill-none'
      ></path>
      <path
        d='M22.1 28L7.2 33.1l14.9 5.1v5.9L0 35.3v-4.4L22.1 22v6z'
        className='fill-none'
      ></path>
      <path
