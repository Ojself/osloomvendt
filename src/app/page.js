  ...
  return (
    <main className='h-[94vh]'>
      <div className='flex h-full flex-col items-center justify-center overflow-hidden bg-blackish'>
        ...
        <Link className='w-full' href={currentEventUrl}>
          <div
            className={`pride mb-20  flex h-32 w-full items-center sm:h-36 md:h-40 lg:h-64 `}
          >
            <h1 className='w-full select-none whitespace-nowrap text-center font-anton text-6xl transition sm:text-8xl md:text-9xl lg:text-10xl'>
              OSLO OMVENDT
            </h1>
          </div>
        </Link>
