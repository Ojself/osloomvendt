...
const threeLinearStyle = {
  background: `linear-gradient(127deg, rgba(83,102,197,.3), rgba(83,102,197,0) 70.71%), linear-gradient(336deg, rgba(134, 255, 107,.4), rgba(134, 255, 107,0)  70.71%), linear-gradient(217deg, rgba(155,108,255,.8), rgba(155,108,255,0) 70.71%) `,
};

const middleBlobStyle = {
  backgroundImage:
    'linear-gradient(to right, black, rgba(83,102,197,0.4) 50%, black 800px)',
      ...
      <div style={middleBlobStyle} className='h-[1000px] w-[1000px] p-6'>
        ...
        {allDatesShort.map((eventDate) => {
          ...
          return (
            ...
            >
              <div
                className={`sticky top-0 z-40 mt-6 flex border-b-2 border-b-[#5366C5] bg-transparent  py-2 pl-4 font-source-code-pro text-lg font-bold text-[#5366C5] sm:text-xl md:text-2xl lg:text-3xl`}
              >
